...
<table id="example" class="table table-striped" style="width: 100%">
  ...
  <tbody>
    ...
    foreach ($arrayReservationInfo as $reservations) {
      ...
      $formattedTimeStart = date("g:i A", strtotime($reservationTimeStart));
      $formattedTimeEnd = date("g:i A", strtotime($reservationTimeEnd));
    ...
    foreach ($arrayWalkinDetails as $walkin) {
      ...
      $formattedWalkinTimeStart = date("g:i A", strtotime($walkinTimeStart));
      $formattedWalkinTimeEnd = date("g:i A", strtotime($walkinTimeEnd));
