...
if (isset($_SESSION["userSuperAdminID"]) || isset($_SESSION["userAdminID"])) { // Check for admin session too
  ...
  <body>
      ...
      <div class="container-fluid" id="profmanage-add-new-profile">
        <form class="row dashboard-square-kebab needs-validation" id="booking-form" novalidate>
          <div class="col-md-4 mb-2">
            ...
            <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Enter first name here"
              required onblur="handleInput(event)" oninput="validateName(event)" maxlength="50">
          ...
          <div class="col-md-4 mb-2">
            ...
            <input type="text" class="form-control" id="middleName" name="middleName" placeholder="Enter middle name here"
              onblur="handleInput(event)" oninput="validateName(event)" maxlength="50">
            <div class="valid-feedback">
              <!-- Looks good! -->
            </div>
            <div class="invalid-feedback">
          ...
          <div class="col-md-4 mb-2">
            ...
            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Enter last name here"
              required onblur="handleInput(event)" oninput="validateName(event)" maxlength="50">
            <div class="valid-feedback">
              <!-- Looks good! -->
            </div>
          ...
          <div class="col-md-4 mb-2">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="Enter email here" required
              oninput="validateEmail(event)" onblur="handleInput(event)" maxlength="50">
            <div class="valid-feedback">
              <!-- Looks good! -->
            </div>
          ...
          <div class="col-md-4 mb-2">
            ...
            <input type="text" class="form-control" id="contactNumber" placeholder="Enter contact number here"
              name="contactNumber" required minlength="11" maxlength="11" oninput="validateContactNumber(event)">
            <div class="valid-feedback">
              <!-- Looks good! -->
            </div>
            <div class="invalid-feedback">
          ...
          <div class="col-md-6 mb-2">
            ...
            <input type="text" class="form-control" id="controlNumber"
              placeholder="Enter control number here (e.g., 00-0000)" name="controlNumber" required minlength="7"
              maxlength="7" onblur="validateControlNumber(event)">
            <div class="valid-feedback">
              <!-- Looks good! -->
            </div>
          ...
          <div class="col-md-6 mb-2">
            ...
            <input type="date" class="form-control" id="validity" placeholder="Enter birthDate here" name="validity"
              required onblur="handleInput(event)" oninput="validateUsername(event)">
            <div class="valid-feedback">
              <!-- Looks good! -->
            </div>
            <div class="invalid-feedback">
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="input-group">
              <input type="password" class="form-control" name="password" id="password" placeholder="Enter password here"
                required oninput="checkPasswordStrength(this)" maxlength="50" />
          ...
          <div class="col-12 col-md-6">
            ...
            <div class="input-group">
              <input type="password" class="form-control" name="confirmPassword" id="confirmPassword"
                placeholder="Re-enter password here" required oninput="checkPasswordMatch()" maxlength="50" />
          ...
          <div class="row justify-content-end mt-5">
            ...
            <div class="col-12 col-md-2 mb-2 mb-md-0">
              ...
              <button class="btn btn-outline-primary w-100 cancel-button" type="button"
    ...
    <div class="modal fade" id="confirmAddWalkin" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
      aria-labelledby="successModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" id="add-new-service-modal">
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title fw-bold text-center" id="wait"><img src="src/images/icons/hourglass.gif"
                alt="Wait Icon" class="modal-icons">Wait!</h2>
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary create-button" data-bs-toggle="modal"
              data-bs-target="#success-add-walkin-modal">Confirm</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal fade" id="success-add-walkin-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
      aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" id="wait">
          <div class="modal-header">
            <h2 class="modal-title  fw-bold text-center" id="success"><img src="src/images/icons/available-worldwide.gif"
                alt="Wait Icon" class="modal-icons">Success!</h2>
          </div>
          <div class="modal-body text-center">
            You have successfully registered a new account.
          </div>
          <div class="modal-footer">
            <button class="btn btn-primary  create-button" name="submitWalkin" id="submitWalkin"
    ...
    <div class="modal fade" id="unsavedChangesModal" tabindex="-1" data-bs-backdrop="static"
      ...
      <div class="modal-dialog modal-dialog-centered" id="">
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title fw-bold text-center" id="wait"><img src="src/images/icons/alert.gif" alt="Wait Icon"
                class="modal-icons">Leaving Page?</h2>
          </div>
          <div class="modal-body">
            <p class="text-center">Looks like you’re in the middle of writing something. Changes that you’ve made will not
              be saved.</p>
