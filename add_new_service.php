...
?>
    ...
    <input type="text" class="form-control" id="serviceRate" name="serviceRate" placeholder="Enter rate here" required oninput="handleInput2(event)" onblur="handleInput(event)" oninput="validateRate(event)" maxlength="5">
    <div class="valid-feedback">Looks good!</div>
